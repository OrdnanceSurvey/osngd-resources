...
CREATE TABLE add_isl_builtaddress_altadd (
...
CREATE TABLE add_isl_builtaddress_rltenty (
...
CREATE TABLE add_isl_builtaddress_otrclass (
...
CREATE TABLE add_isl_streetaddress (
	...
	geometry geometry(MultiPoint, 4258) not null,
